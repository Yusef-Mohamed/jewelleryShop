            ...
            [...Array(4)].map((_, ind) => (
              <div className="px-2" key={ind}>
                <div className="relative w-full p-4 h-full aspect-[1/1.5]  skeleton">
                  <div className="font-semibold bg-white rounded-full py-2 text-center shadow-sm absolute bottom-5 left-[50%] w-1/2 translate-x-[-50%]"></div>
                </div>
              </div>
            ))}
            ...
            <div key={category._id} className="px-2">
              ...
              >
                <img
                  ...
                  alt=""
                />
                <div className="font-semibold bg-white rounded-full py-2 text-center shadow-sm border border-slate-200 absolute bottom-5 left-[50%] w-1/2 translate-x-[-50%]">
                  {category.name}
                </div>
              </Link>
            </div>
